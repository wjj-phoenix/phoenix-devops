...
public class SysMenuTableDef extends TableDef {
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, PARENT_ID, NAME, CODE, ICON, URL, METHOD, TYPE, SORT, HIDDEN, REDIRECT, DESCRIPTION, CREATED_TIME, UPDATED_TIME};
