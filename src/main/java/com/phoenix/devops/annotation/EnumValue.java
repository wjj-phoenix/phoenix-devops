...
import com.phoenix.devops.model.code.NameValueEnum;
import com.phoenix.devops.model.code.ValueEnum;
import com.phoenix.devops.utils.EnumUtil;
...
public @interface EnumValue {
    ...
    class EnumValueValidator implements ConstraintValidator<EnumValue, Object> {
        ...
        private void setErrorEnumPlaceholderValue(Object value, Object[] values, ConstraintValidatorContext context) {
            ...
            if (StringUtil.isEmpty(enumValue.name()) && enumClass != DefaultEnum.class) {
